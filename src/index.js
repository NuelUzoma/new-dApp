...
let toUpperTotal = 0 // succesful transactions count

async function handle_advance(data) { // keen to web2 post requests
  ...
  if (isNumeric(sentence)) {
    // TODO: Add error output (error handling)
  ...
  users.push(sender) // Push the list of senders so it can be viewed
  toUpperTotal += 1
...
async function handle_inspect(data) { // keen to web2 get requests
